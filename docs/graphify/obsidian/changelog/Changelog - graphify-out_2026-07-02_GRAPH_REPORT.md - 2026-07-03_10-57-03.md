# Changelog: graphify-out/2026-07-02/GRAPH_REPORT.md
...
## Diff
```diff
diff --git a/graphify-out/2026-07-02/GRAPH_REPORT.md b/graphify-out/2026-07-02/GRAPH_REPORT.md
new file mode 100644
index 0000000..e83f152
--- /dev/null
+++ b/graphify-out/2026-07-02/GRAPH_REPORT.md
@@ -0,0 +1,2643 @@
...
+- [[_COMMUNITY_test_install  # Truncated to 5000 chars for readability if huge
```
